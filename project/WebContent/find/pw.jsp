...
<head>
  ...
  <script charset="UTF-8" src="./js/pw.js"></script>
  <title>비밀번호 찾기</title>
</head>
<!-- 공통헤더 -->
    ...
    <div class="inner-container">
        ...
        <div class="find-input-wrap">
            <div class="inner-input-wrap">
                <div class="find-form">
                    <p class="info">가입하셨던 이메일 계정을 입력하시면,<br>비밀번호를 새로 만들 수 있는 링크를 이메일로<br>발송해드립니다.</p>
                    <form action="">
                        <div class="input-con">
                            <input type="email" id="userName" name="userName" class="input_txt"placeholder="이메일 입력">
                            <p class="message_wrap">이메일 형식이 올바르지 않습니다.</p>
                        </div>
                        <button type="button" id="findBtn" class="full_btn" onclick="fn_layerOpen('#findPwLayer')">링크 발송</button>
                    </form>
                </div>
            </div>
        </div>
...
<!-- 레이어창 -->
<div class="layer-popup" id="findPwLayer">
    <div class="layer-bg" onclick="fn_layerClose('#findPwLayer')"></div>
    <div class="inner-layer">
      <div class="layer-head">
        <button type="button" class="close-btn" onclick="fn_layerClose('#findPwLayer')">
      ...
      <div class="layer-body">
        <div class="inner">
            <h3>발송 완료</h3>
            <p>작성하신 이메일로 비밀번호를 등록할 수 있는 링크를 발송했으니 이메일을 확인해주세요.</p>
        </div>
      </div>
      <!--layer-body-->
      <div class="layer-foot">
        <div class="btn-wrap">
          <button type="button" class="blank2_btn">확인</button>
        </div>
      </div>
      <!--layer-foot-->
    </div>
